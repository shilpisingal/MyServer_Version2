...
import java.util.concurrent.Executors;
	...
	public class SimpleServer {
	    ...
	    public void startServer() {
			...
			if(rp.getPropertyValue("portNum") ==null ||rp.getPropertyValue("portNum").trim()=="") 
			{
				System.out.println("Port Number can't be null");
			    return;
			}
	        ...
	        try {
	            ...
	            {
	            	System.out.println("Server couldn't be started on specified port:"+portNo);
	            }
